...
function Register() {
  const {register,handleSubmit,formState:{errors,loading}}=useForm()
...
<label className="text-sm text-gray-200 " htmlFor="">full name</label>
    ...
    <input {...register('name' ,{required:true})} type="text" placeholder="enyer full name" className="w-full p-3 outline-0 rounded-xl  bg-white/10 border border-white/20 text-white placeholder-gray-300 focus:ring-2  focus:ring-purple-400"/>
